...
class AuthController extends Controller
{
    ...
    // DELETE /user/account
    /**
     * Permanently delete / anonymize the member account (Apple 5.1.1(v) / Play).
     * Order and wallet ledger rows are retained for financial audit without PII.
     */
    public function deleteAccount(Request $request)
    {
        ...
        // Free the email for future registration; strip personal data.
        $user->tokens()->delete();
        $user->forceFill([
            'name'         => 'Deleted User',
